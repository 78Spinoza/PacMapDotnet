...
namespace PacMAPSharp
{
    ...
    internal struct PacmapHnswConfig
    {
      ...
      public bool DensityScaling;  // Apply dimension-based density scaling (O(sqrt(d)) behavior) - CRITICAL: Added to match Rust struct
        ...
        public static PacmapHnswConfig Default => new PacmapHnswConfig
        {
            ...
            EfSearch = 64,
            MemoryLimitMb = 0,
            DensityScaling = true, // Maintain current behavior by default
    ...
    public class PacMAPModel : IDisposable
    {
        ...
        private const string EXPECTED_DLL_VERSION = "0.3.4";
