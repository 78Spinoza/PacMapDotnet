...
pub fn sample_fp_pair_with_progress(
    ...
    pair_fp
        ...
        .for_each(|(i, mut pairs)| {
            ...
            let mut rng = SmallRng::seed_from_u64(config.random_state + i as u64);
...
pub fn sample_mn_pair_with_progress(
    ...
    pair_mn
        ...
        .enumerate()
        .for_each(|(i, mut pairs)| {
            let mut rng = SmallRng::seed_from_u64(config.random_state + i as u64 + 1000); // Offset to avoid correlation
            for j in 0..n_mn {
